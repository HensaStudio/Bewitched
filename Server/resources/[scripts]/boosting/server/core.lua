...
function Hensa.Accept(Selected)
	...
	if Passport and not Active[Passport] then
		if vRP.TakeItem(Passport,"platinum",Pendings[Passport][Selected]["Value"]) then
			...
			TriggerClientEvent("Notify",source,"Atenção","Você precisa de <b>"..Pendings[Passport][Selected]["Value"].."x "..ItemName("platinum").."</b>.","amarelo",5000)
		end
	end
