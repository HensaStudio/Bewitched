	...
	if LocalPlayer["state"]["Admin"] and not IsPauseMenuActive() then
		if not LocalPlayer["state"]["Commands"] and not LocalPlayer["state"]["Handcuff"] and not Dynamic and not LocalPlayer["state"]["Bennys"] and MumbleIsConnected() then
			if GlobalState["Commands"] then
				...
				exports["dynamic"]:AddButton("Give "..ItemName("gemstone").."s.", "Inserir "..ItemName("gemstone").."s no ID.", "admin:Dynamic", "addgem", "wallet", true)
				exports["dynamic"]:AddButton("Remove "..ItemName("gemstone").."s.", "Remover "..ItemName("gemstone").."s no ID.", "admin:Dynamic", "remgem", "wallet", true)
				...
				exports["dynamic"]:AddButton("Point Cds", "Pegue a coordenada com ponteiro.", "postit:initAdminPostit", "", "basic", false)
				exports["dynamic"]:AddButton("Cds", "Pegue a sua coordenada atual.", "admin:Dynamic", "cds", "basic", true)
