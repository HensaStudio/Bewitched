...
Single = {
	...
	["26"] = { ["Coords"] = vec4(-1278.84,-1119.88,6.76,181.31), ["Mode"] = "Barbershop" },
	["27"] = { ["Coords"] = vec4(141.52,-1706.78,28.94,229.45 ), ["Mode"] = "Barbershop" },
	["28"] = { ["Coords"] = vec4(1215.54,-476.33,65.89,165.22), ["Mode"] = "Barbershop" },
	["29"] = { ["Coords"] = vec4(-36.73,-155.15,56.9,70.02 ), ["Mode"] = "Barbershop" },
	["30"] = { ["Coords"] = vec4(-824.55,-183.48,37.31,120.66), ["Mode"] = "Barbershop" },
	["31"] = { ["Coords"] = vec4(-92.9,6234.89,30.82,123.09), ["Mode"] = "Galinheiro" },
	["32"] = { ["Coords"] = vec4(-527.21,5335.25,80.01,161.45), ["Mode"] = "Madeireira" },
	["33"] = { ["Coords"] = vec4(986.52,-2176.56,29.8,83.18), ["Mode"] = "Acougue" },
	["34"] = { ["Coords"] = vec4(-630.92,-228.29,37.8,37.1), ["Mode"] = "Grandes" },
	["35"] = { ["Coords"] = vec4(-106.63,6477.81,31.32,41.48), ["Mode"] = "Grandes" },
	["36"] = { ["Coords"] = vec4(-2958.53,481.02,15.51,85.11), ["Mode"] = "Grandes" },
	["37"] = { ["Coords"] = vec4(252.46,215.9,101.39,159.2), ["Mode"] = "Central" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- MULTIPLIER
-----------------------------------------------------------------------------------------------------------------------------------------
