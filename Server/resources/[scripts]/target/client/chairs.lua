...
local Chairs = {
	...
	[-470815620] = { ["OffsetX"] = 0.0, ["OffsetY"] = 0.0, ["OffsetZ"] = -0.1, ["Heading"] = 180.0 },
	[1290593659] = { ["OffsetX"] = 0.0, ["OffsetY"] = 0.0, ["OffsetZ"] = 0.45, ["Heading"] = 180.0 },
	[47332588] = { ["OffsetX"] = 0.0, ["OffsetY"] = 0.0, ["OffsetZ"] = 0.45, ["Heading"] = 180.0 },
	[2040839490] = { ["OffsetX"] = 0.0, ["OffsetY"] = 0.0, ["OffsetZ"] = 0.0, ["Heading"] = 180.0 },
	[-1971298567] = { ["OffsetX"] = 0.0, ["OffsetY"] = 0.0, ["OffsetZ"] = 0.35, ["Heading"] = 180.0 },
	[-1761659350] = { ["OffsetX"] = 0.0, ["OffsetY"] = 0.0, ["OffsetZ"] = 0.5, ["Heading"] = 180.0 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSERVERSTART
-----------------------------------------------------------------------------------------------------------------------------------------
CreateThread(function()
	AddTargetModel({ -1235256368,538002882,-1118419705,-377849416,-109356459,-1692811878,-729914417,1577885496,1889748069,1816935351,1037469683,536071214,438342263,2129125614,195568113,1827229923,-1078931853,-470815620,1290593659,47332588,2040839490,-1971298567,-1761659350 },{
		options = {
			{
				event = "target:Chair",
				label = "Sentar",
