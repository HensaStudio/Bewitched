...
local TowedSouth = PolyZone:Create({
	vec2(-129.17948913574,-1159.0358886719),
	vec2(-129.3606262207,-1186.4090576172),
	vec2(-156.98167419434,-1186.3138427734),
	vec2(-183.94802856445,-1185.8614501953),
	vec2(-200.09059143066,-1186.0811767578),
	vec2(-217.41801452637,-1185.8596191406),
	vec2(-226.18653869629,-1185.861328125),
	vec2(-246.64981079102,-1186.2763671875),
	vec2(-248.50628662109,-1184.0928955078),
	vec2(-246.53890991211,-1158.9216308594),
	vec2(-226.32305908203,-1159.3909912109),
	vec2(-216.99395751953,-1160.8421630859),
	vec2(-200.17329406738,-1160.8421630859),
	vec2(-199.68745422363,-1168.908203125),
	vec2(-182.66030883789,-1168.6575927734),
	vec2(-182.36555480957,-1160.8421630859),
	vec2(-165.42118835449,-1161.1358642578),
	vec2(-155.89372253418,-1161.4914550781),
	vec2(-155.78198242188,-1159.171875)
},{ name = "TowedSouth" })
-----------------------------------------------------------------------------------------------------------------------------------------
-- TYRES
-----------------------------------------------------------------------------------------------------------------------------------------
...
AddEventHandler("onClientResourceStart",function(Resource)
	...
	AddCircleZone("Impound01", vec3(-193.0,-1162.38,24.01), 0.5, {
		name = "Impound01",
		heading = 0.0
	}, {
		Distance = 1.25,
