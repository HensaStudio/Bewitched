...
AddEventHandler("onClientResourceStart",function(Resource)
	...
	RemoveIpl("ba_case8_solomun")
	RemoveIpl("ba_case9_madonna")
	RemoveIpl("ba_case3_madonna")
	RemoveIpl("ba_case4_dixon")
	RemoveIpl("ba_case2_madonna")
	RemoveIpl("ba_sm_boat_window")
	RemoveIpl("ba_case1_madonna")
	RemoveIpl("ba_case5_madonna")
	RemoveIpl("ba_case9_solomun")
	RemoveIpl("ba_case6_taleofus")
	RemoveIpl("ba_case4_solomun")
	RemoveIpl("ba_case7_solomun")
	RemoveIpl("ba_case3_forsale")
	RemoveIpl("ba_case4_forsale")
	RemoveIpl("ba_case6_solomun")
	RemoveIpl("ba_case0_forsale")
	RemoveIpl("ba_case8_dixon")
	RemoveIpl("ba_case7_madonna")
	RemoveIpl("ba_case8_forsale")
	RemoveIpl("ba_case5_dixon")
	RemoveIpl("ba_barriers_case1")
	RemoveIpl("ba_case5_forsale")
	RemoveIpl("ba_barriers_case7")
	RemoveIpl("ba_case2_dixon")
	RemoveIpl("ba_case2_taleofus")
	RemoveIpl("ba_case3_taleofus")
	RemoveIpl("ba_case8_madonna")
	RemoveIpl("ba_case9_taleofus")
	RemoveIpl("ba_case3_solomun")
	RemoveIpl("ba_case8_taleofus")
	RemoveIpl("ba_case0_madonna")
	RemoveIpl("ba_case6_madonna")
	RemoveIpl("ba_case5_solomun")
	RemoveIpl("ba_case6_dixon")
	RemoveIpl("ba_case2_solomun")
	RemoveIpl("ba_case1_forsale")
	RemoveIpl("ba_barriers_case6")
	RemoveIpl("ba_case2_forsale")
	RemoveIpl("ba_case1_solomun")
	RemoveIpl("ba_case0_solomun")
	RemoveIpl("ba_barriers_case9")
	RemoveIpl("ba_case7_dixon")
	RemoveIpl("ba_barriers_case2")
	RemoveIpl("ba_case9_forsale")
	RemoveIpl("ba_case4_taleofus")
	RemoveIpl("ba_barriers_case4")
	RemoveIpl("ba_case0_dixon")
	RemoveIpl("ba_case1_taleofus")
	RemoveIpl("ba_barriers_case0")
	RemoveIpl("ba_case0_taleofus")
	RemoveIpl("ba_case7_taleofus")
	RemoveIpl("ba_case5_taleofus")
	RemoveIpl("ba_case1_dixon")
	RemoveIpl("ba_case4_madonna")
	RemoveIpl("ba_barriers_case3")
	RemoveIpl("ba_case9_dixon")
	RemoveIpl("ba_barriers_case5")
	RemoveIpl("ba_case7_forsale")
	RemoveIpl("ba_case6_forsale")
	RemoveIpl("ba_barriers_case8")
	RemoveIpl("ba_case3_dixon")
	...
	-- DOLLARS
	RequestIpl("m24_1_dlc_int_bounty")
	RequestIpl("m24_1_int_placement_m24_1_interior_dlc_int_bounty_milo_")
	RequestIpl("m24_1_bailoffice_davis")
	RequestIpl("m24_1_bailoffice_delperro")
	RequestIpl("m24_1_bailoffice_missionrow")
	RequestIpl("m24_1_bailoffice_paletobay")
	RequestIpl("m24_1_bailoffice_vinewood")
	RequestIpl("m24_1_dlc_int_mod")
	RequestIpl("m24_1_int_placement_m24_1_g9ec_interior_0_dlc_int_mod_milo_")

	-- CARRIER
	RequestIpl("m24_1_carrier")
	RequestIpl("m24_1_carrier_int1")
	RequestIpl("m24_1_carrier_int2")
	RequestIpl("m24_1_carrier_int3")
	RequestIpl("m24_1_carrier_int4")
	RequestIpl("m24_1_carrier_int5")
	RequestIpl("m24_1_carrier_int6")
	RequestIpl("m24_1_carrier_ladders")
	...
	-- AGENS OF SABOTAGE
	RequestIpl("m24_2_airstrip")
	RequestIpl("m24_2_airstrip_lod")
	RequestIpl("m24_2_cargoship_overlay")
	RequestIpl("m24_2_garment_factory")
	RequestIpl("m24_2_garment_factory_door")
	RequestIpl("m24_2_garment_factory_lod")
	RequestIpl("m24_2_hanger_additions")
	RequestIpl("m24_2_legacy_fixes")
	RequestIpl("m24_2_mfh_finale_ground")
	RequestIpl("m24_2_mfh_finale_ground_lod")
	RemoveIpl("m24_2_prop_m42_hangerdoor_02a")
end)